...
class Command(BaseCommand):
    ...
    def handle(self, *args, **kwargs):
        # List of default categories to create, each with a name and a friendly name
        categories = [
        ...
        for category_data in categories:
            # Use get_or_create to avoid duplicate entries. It will get the category if it exists,
